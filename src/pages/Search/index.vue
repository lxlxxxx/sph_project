    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder(1)">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-arrow_down':isDesc,'icon-up-arrow':isAsc}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder(2)">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-arrow_down':isDesc,'icon-up-arrow':isAsc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :countinues="5" @getPageNo="getPageNo"></Pagination>
        </div>
      </div>
    </div>
  </div>
